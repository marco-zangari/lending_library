...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='Jon', last_name='Doeod')
        test_genre = Genre.objects.create(name='Fantasy')
        test_language = Language.objects.create(name='English')
        test_book = Book.objects.create(
            title='All Hands',
            summary='lots of hands. everyone shows up.',
            isbn='0123456789',
            author=test_author,
    ...
    def renew_book_librarian(request, pk):
        ...
        if request.method == 'POST':
            ...
            proposed_renewal_date = datetime.date.today() + datetime.timedelat(weeks=3)
...
class AuthorListViewTest(TestCase):
    ...
    def test_authors_view_url_accessible_by_name(self):
        """."""
        response = self.client.get('/catalog/authors/')
        self.assertEqual(response.status_code, 200)

    def test_authors_view_uses_correct_template(self):
        """."""
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='John', last_name='Schmoo')
        test_genre = Genre.objects.create(name='Fantasy')
        test_language = Language.objects.create(name='English')

        test_book = Book.objects.create(
            title='Book Title',
            summary='the summary of the awesome book',
            isbn='012012012',
            author=test_author,
            language=test_language,
            )
        ...
        self.test_bookinstance1 = BookInstance.objects.create(
            book=test_book,
            imprint='Unexpected Imprint, 2018',
            due_back=return_date,
            borrower=test_user1,
            status='o',
            )
